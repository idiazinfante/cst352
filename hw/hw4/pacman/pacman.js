...
function loadComplete(){
    ...
    //inside walls
    createWall(160, 280, 280, 40);
    createWall(480,200,40,120);
    createWall(80,240,40,80);
    createWall(160,200,80,40);
    createWall(280,160,40,80);
    createWall(360,200,80,40);
    createWall(360,160,80,40);
    createWall(360,80,160,40)
    createWall(480,120,40,40);
    createWall(160,80,160,40);
    createWall(160,120,40,40);
